    ...
    */ 
    function checkChoice(playerChoice) {
        ...
        if (playerChoice == computerChoice) {
            ...
            console.log(" ")
            gameResult.innerHTML = "Computer chose " + computerChoice + ", It's a tie!\n"
        } else if ((playerChoice == "rock" && computerChoice == "paper") || (playerChoice == "paper" && computerChoice == "scissors") || (playerChoice == "scissors" && computerChoice == "rock")){
            console.log("Computer chose: " + computerChoice);
            console.log("You loose...");
            console.log(" ")
            gameResult.innerHTML = "Computer chose " + computerChoice +", You lose...\n"
        } else {
            console.log("Computer chose: " + computerChoice);
            console.log("You Win!");
            console.log(" ")
            gameResult.innerHTML = "Computer chose " + computerChoice + ", You win!\n"
        }
    }
});